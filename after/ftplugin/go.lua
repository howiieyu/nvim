	...
	callback = function()
		...
		if col > 0 and line:sub(col, col) == "," then
			...
			if match then
				...
				local end_col_after_comma =
				col       -- The comma was typed at 'col', so we replace up to and including 'col'
				...
				-- The new text is "(int, )"
				vim.api.nvim_buf_set_text(0, lnum, start_col_return_type, lnum, end_col_after_comma,
					{ new_text })
